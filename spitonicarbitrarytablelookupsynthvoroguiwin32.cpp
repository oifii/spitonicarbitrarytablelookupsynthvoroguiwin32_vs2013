...
#include "stdafx.h"
#include "spitonicarbitrarytablelookupsynthvoroguiwin32.h"
#include "FreeImage.h"
...
ArbitraryTableLookupSynth* global_pSynth;
...
TCHAR szTitle[1024]={L"spitonicarbitrarytablelookupsynthvoroguiwin32title"};					// The title bar text
TCHAR szWindowClass[1024]={L"spitonicarbitrarytablelookupsynthvoroguiwin32class"};				// the main window class name
                     ...
                     int       nCmdShow)
{
	...
	*/
	...
	global_pSynth = new(ArbitraryTableLookupSynth);
